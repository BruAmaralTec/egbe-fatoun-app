...
export const DEFAULT_PERMISSIONS = {
  ...
  conselho: ["eventos", "cursos", "ose", "biblioteca", "dicionario", "pagamentos", "notificacoes", "membros", "admin-eventos", "admin-cursos", "admin-usuarios", "admin-certificados", "admin-rituais"],
  sacerdote: ["eventos", "cursos", "ose", "biblioteca", "dicionario", "pagamentos", "notificacoes", "membros", "admin-eventos", "admin-cursos", "admin-usuarios", "admin-certificados", "admin-rituais", "admin-financeiro"],
